...
Release a new version of django-hookflow to PyPI via GitHub Actions.
...
1. Read the current version from `src/django_hookflow/__init__.py`
...
4. Update the version in `src/django_hookflow/__init__.py` (the `__version__` variable)
